...
model = torch.load(r'F:\wzy\TrussStructureActivityRelationship\model\NN\vyx\neural_network_vyx.pt', map_location=device, weights_only=False)
model.eval()
background_size = 50
...
shap_df.to_csv(r'F:\wzy\TrussStructureActivityRelationship\shap_analysis\all_shap_values_vyx.csv', index=False)
