...
model = torch.load(r'F:\wzy\TrussStructureActivityRelationship\model\NN\ey\neural_network_ey.pt', map_location=device, weights_only=False)
model.eval()
background_size = 50
...
shap_df.to_csv(r'F:\wzy\test_shap\shap_analysis\all_shap_values_ey.csv', index=False)
