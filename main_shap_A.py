...
model = torch.load(r'F:\wzy\TrussStructureActivityRelationship\model\NN\A\neural_network_A.pt', map_location=device, weights_only=False)
model.eval()
background_size = 50
...
shap_df.to_csv(r'F:\wzy\TrussStructureActivityRelationship\shap_analysis\all_shap_values_A.csv', index=False)
